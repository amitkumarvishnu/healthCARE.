    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50">
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="mb-4">
                    <label className="block text-sm font-bold text-black mb-1" htmlFor="dateTime">Requested Time:</label>
                    <input
                        id="dateTime"
                        type="datetime-local"
                        value={dateTime}
                ...
                <div className="mb-4">
                    <label className="block text-sm font-bold text-black mb-1" htmlFor="description">Description:</label>
                    <textarea
                        id="description"
                        value={description}
                ...
                <div className="mb-4">
                    <label className="block text-sm font-bold text-black mb-1" htmlFor="image">Upload Image:</label>
                    <input
                        id="image"
                        type="file"
